...
#     new_gui.config(backgorund="white")
...
#     cal_content = calendar.calendae(fetch_year)

#     cal_year = Label(new_gui, text=cal_content, font="Times New Roman 12")
